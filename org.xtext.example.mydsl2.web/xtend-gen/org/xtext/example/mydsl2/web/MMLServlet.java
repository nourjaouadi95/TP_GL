...
import org.xtext.example.mydsl2.web.MMLWebSetup;
...
public class MMLServlet extends XtextServlet {
  ...
  public void init() {
    try {
      super.init();
      final Injector injector = new MMLWebSetup().createInjectorAndDoEMFRegistration();
